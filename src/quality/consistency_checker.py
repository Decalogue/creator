...
class Issue:
    """一致性问题"""
    type: str  # character, setting, plot, style
    severity: str  # critical, major, minor
    description: str
    location: Optional[str] = None  # 问题位置（章节、段落等）
...
如果没有问题，请回复"无问题"。"""
            ...
            if "无问题" not in response and "一致" in response.lower():
                return [Issue(
                    ...
                    suggestion=response[:200]  # 截取前200字符作为建议
                )]
