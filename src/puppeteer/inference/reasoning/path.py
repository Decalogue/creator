...
class GraphReasoningPath:
    ...
    def step(self):
        ...
        ***REMOVED*** Deal with the case meeting the termination condition:
        ***REMOVED*** 1. The current agent is the terminator 
        ***REMOVED*** 2. The maximum number of steps is reached
        ...
        ***REMOVED*** Deal with the case where the current agent is the terminator
        ...
        ***REMOVED*** Deal with the case where there is only one next agent
        ...
        ***REMOVED*** Deal with the case where there are multiple next agents
        else:
