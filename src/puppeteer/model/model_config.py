...
class ModelConfig:
    ...
    provider: str          
    max_tokens: int      
    model_size: int   ***REMOVED*** for open-source models, this is the number of parameters in millions; but for API models, this is just an estimate
...
MODEL_REGISTRY: Dict[str, ModelConfig] = {
    "gpt-3.5": ModelConfig(
        ...
        provider="openai",
        model_size=175,***REMOVED*** which is estimated
        max_tokens=4096,
    ...
    "gpt-4o": ModelConfig(
        ...
        provider="openai", 
        model_size=200,***REMOVED*** which is estimated
        max_tokens=128000,
        description="OpenAI GPT-4o model"
    ),
    "qwen": ModelConfig(
        name = "qwen",
        function_name="query_qwen",
        api_model_name="qwen-2.5",
        provider="local",
        model_size=7,
        max_tokens=8192,    
        url="http://localhost:6002/v1",
        description="Qwen2.5-7B-Instruct model deployed locally"
    ),
}
