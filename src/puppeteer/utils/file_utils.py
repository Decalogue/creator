...
***REMOVED*** =============================
***REMOVED*** File / JSON / Code Utilities
***REMOVED*** =============================
...
def iter_jsonl(data_path: str) -> List[dict]:
    with open(data_path, 'r', encoding='utf-8') as f:
        return [json.loads(line) for line in f if line.strip()]  ***REMOVED*** 跳过空行
...
def extract_code_from_text(text: str) -> str:
    ...
    ***REMOVED*** Search for longest valid code segment
