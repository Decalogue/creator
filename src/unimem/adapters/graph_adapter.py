...
class GraphAdapter(BaseAdapter):
    ...
    def extract_entities_relations(self, text: str) -> Tuple[List[Entity], List[Relation]]:
        ...
        # TODO: 调用 LightRAG 的实体关系抽取
        # 但转换为 UniMem 的 Entity 和 Relation 类型
