...
***REMOVED******REMOVED******REMOVED*** 1. Word 模板生成
- 自动创建标准化的 Word 模板
- 包含所有必要的字段和说明
- 用户只需填写内容即可

***REMOVED******REMOVED******REMOVED*** 2. 智能文档解析
- 自动识别视频类型、平台、时长等基本信息
- 提取任务需求、修改需求、通用记忆等
- 支持键值对格式的用户偏好和商品信息

***REMOVED******REMOVED******REMOVED*** 3. UniMem 深度集成
- 自动检索相关的历史创作
- 提取成功的创作模式
- 学习用户的风格偏好
- 将每次生成的剧本存储到 UniMem

***REMOVED******REMOVED******REMOVED*** 4. 交互式优化
- 支持多轮反馈优化
- 自动提取修改需求
- 持续改进剧本质量
...
***REMOVED******REMOVED******REMOVED*** 方式一：命令行模式

***REMOVED******REMOVED******REMOVED******REMOVED*** 1. 创建 Word 模板
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 2. 填写模板
...
***REMOVED******REMOVED*** Word 模板字段说明

***REMOVED******REMOVED******REMOVED*** 一、视频基本信息（必填）
...
***REMOVED******REMOVED******REMOVED*** 二、当前任务需求
...
***REMOVED******REMOVED******REMOVED*** 三、修改需求（可选）

如果在已有脚本基础上进行修改，填写修改要求。

***REMOVED******REMOVED******REMOVED*** 四、通用记忆总结（可选）
...
***REMOVED******REMOVED******REMOVED*** 五、用户偏好设置（可选）
...
***REMOVED******REMOVED******REMOVED*** 六、商品信息（仅电商题材）
...
***REMOVED******REMOVED******REMOVED*** 七、镜头素材

描述可用的镜头素材，每行一个，例如：
- 镜头1: 产品特写，展示手机外观
- 镜头2: 使用场景，年轻人拍照

***REMOVED******REMOVED*** 示例：完整工作流程

***REMOVED******REMOVED******REMOVED*** 1. 创建模板

```bash
python generate_video_script.py --template
```

***REMOVED******REMOVED******REMOVED*** 2. 填写模板
...
***REMOVED******REMOVED******REMOVED*** 3. 生成剧本（交互式）
...
***REMOVED******REMOVED******REMOVED*** 4. 查看生成结果
...
***REMOVED******REMOVED******REMOVED*** 5. 优化剧本
...
***REMOVED******REMOVED*** UniMem 优势体现

***REMOVED******REMOVED******REMOVED*** 自动学习历史经验
...
***REMOVED******REMOVED******REMOVED*** 持续积累知识库
...
***REMOVED******REMOVED******REMOVED*** 问题：模板创建失败
...
***REMOVED******REMOVED******REMOVED*** 问题：解析结果为空
...
***REMOVED******REMOVED******REMOVED*** 问题：UniMem 功能不可用
