...
***REMOVED******REMOVED*** 测试场景设计

***REMOVED******REMOVED******REMOVED*** 场景1: 电商-美妆-小红书（简单需求）
- **复杂度**: 简单
- **特点**: 基础电商推广，3轮反馈优化
- **验证点**: 基础决策痕迹捕获、reasoning提取

***REMOVED******REMOVED******REMOVED*** 场景2: 教育-编程-抖音（中等复杂度）
- **复杂度**: 中等
- **特点**: 知识分享类，需要平衡专业性和通俗性
- **验证点**: 多轮优化、经验提取

***REMOVED******REMOVED******REMOVED*** 场景3: 娱乐-搞笑-抖音（简单）
- **复杂度**: 简单
- **特点**: 轻松幽默风格
- **验证点**: 风格记忆、快速优化

***REMOVED******REMOVED******REMOVED*** 场景4: 电商-服装-淘宝（复杂需求）
- **复杂度**: 复杂
- **特点**: 多角度展示、多场景应用，4轮反馈
- **验证点**: 复杂决策上下文、先例搜索

***REMOVED******REMOVED******REMOVED*** 场景5: 知识-科技-抖音（高复杂度）
- **复杂度**: 复杂
- **特点**: 专业内容通俗化，4轮反馈
- **验证点**: 深度优化、经验模式提取
...
***REMOVED******REMOVED******REMOVED*** 步骤1: 创建Word需求文档
- 自动生成符合格式的Word文档
- 包含任务需求、商品信息、镜头素材等

***REMOVED******REMOVED******REMOVED*** 步骤2: 解析文档
- 使用LLM解析Word文档
- 提取任务记忆、商品信息等

***REMOVED******REMOVED******REMOVED*** 步骤3: 搜索先例
- 使用`search_precedents`方法
- 基于决策上下文搜索相似历史决策
- **验证**: 先例搜索功能是否正常

***REMOVED******REMOVED******REMOVED*** 步骤4: 生成初始剧本
...
***REMOVED******REMOVED******REMOVED*** 步骤5: 多轮反馈优化
- 根据场景配置执行多轮反馈
- 每轮：存储反馈 -> 提取修改需求 -> 优化脚本
- **验证**:
  - 反馈记忆的reasoning提取
...
***REMOVED******REMOVED******REMOVED*** 步骤6: REFLECT操作
- 收集所有相关记忆
- 执行REFLECT操作
- **验证**:
  - 是否提取到新经验
...
***REMOVED******REMOVED******REMOVED*** 步骤7: 验证Context Graph功能
- **验证项**:
...
***REMOVED******REMOVED******REMOVED*** 方法1: 使用启动脚本（推荐）
...
***REMOVED******REMOVED******REMOVED*** 方法2: 直接运行Python脚本

```bash
cd /root/data/AI/creator/src
conda activate myswift  ***REMOVED*** 或 seeme
...
***REMOVED******REMOVED******REMOVED*** 1. 测试结果JSON
...
***REMOVED******REMOVED******REMOVED*** 2. 进化报告JSON
...
***REMOVED******REMOVED******REMOVED*** 3. 运行日志
- 文件名: `context_graph_test_YYYYMMDD_HHMMSS.log`
- 内容: 完整的运行日志

***REMOVED******REMOVED*** 结果分析

***REMOVED******REMOVED******REMOVED*** 关键指标
...
***REMOVED******REMOVED******REMOVED*** 经验模式提取
