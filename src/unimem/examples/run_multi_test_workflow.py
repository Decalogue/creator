...
def analyze_common_patterns(tracker: MultiTestTracker) -> Dict[str, Any]:
    ...
    analysis["modification_counts"] = modification_counts  # 保存计数供后续使用
...
def main():
    ...
    test_configs = [
        {
            "name": "测试1-电商-手机-抖音",
            "doc": "video_script_filled_example.docx",  # 使用已有的文档
            "feedbacks": [
    ...
    if analysis["common_modifications"]:
        ...
        for mod in analysis["common_modifications"][:10]:  # 显示前10个
