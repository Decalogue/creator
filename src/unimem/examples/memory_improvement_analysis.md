...
**改进方案**:
```python
# 在 store_script_to_unimem 中
context = Context(
    metadata={
        "source": "video_script",  # 添加source
...
# 在 store_feedback_to_unimem 中
context = Context(
    metadata={
        "source": "user_feedback",  # 添加source
...
### 修改1: generate_video_script.py - 添加source字段
...
### 修改2: neo4j.py - 改进metadata保存和source提取
