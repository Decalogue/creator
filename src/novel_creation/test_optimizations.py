...
def test_enhanced_extraction():
    ...
    creator = ReactNovelCreator(
        ...
        enable_context_offloading=False,  # 关闭上下文卸载以加快测试
        enable_creative_context=True,
        enable_enhanced_extraction=True,  # 启用增强提取
        enable_unimem=False  # 先测试实体提取
    )
...
def test_full_integration():
    ...
    try:
        creator = ReactNovelCreator(
            ...
            enable_creative_context=True,
            enable_enhanced_extraction=True,
            enable_unimem=False  # 可选：启用 UniMem
        )
