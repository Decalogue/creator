...
def main():
    ...
    # 计算前30个窗口需要的字符数（增加数量以形成链接网络）
    # 窗口大小512，重叠64，每个窗口实际前进 512-64=448 字符
    # 前30个窗口需要：512 + 29 * 448 = 512 + 12992 = 13504 字符
    ...
    try:
        ...
        for i, segment in enumerate(segments, 1):
            try:
                ...
                # 每处理 5 个片段，生成一次链接并进行记忆演化
                if i % 5 == 0 and i >= 10:  # 至少需要10个记忆才能进行演化
