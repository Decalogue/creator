...
### L1: 原子函数调用（Atomic Function Calling）
...
```python
# 通过 L1 的 execute_shell 使用 L2 工具
result = las.execute_l1_function(
    "execute_shell",
...
agent = ReActAgent(
    max_iterations=20,
    enable_context_offloading=True  # 启用上下文卸载
)
