...
from tasks import mmlu_pro, gsm_hard, srdd, creative_writing, novel


def main():
    parser = argparse.ArgumentParser(description="Run benchmark tasks")
    parser.add_argument("task", choices=["MMLU-Pro", "GSM-Hard", "SRDD", "CW", "Novel"])
