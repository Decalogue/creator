...
class Action:
    def __init__(self, action:dict, result:dict, success:str, agent_role:str, agent_model:str):
        self.action = action  ***REMOVED*** format action, e.g., {"action": "", "parameters": ""}
        self.result = result  ***REMOVED*** action result, e.g., {"step_data": "", "answer": ""}
        self.success = success  ***REMOVED*** Success or Failure of the action
        self.agent_role = agent_role  ***REMOVED*** Role of the agent
        self.agent_model = agent_model  ***REMOVED*** Model of the agent
