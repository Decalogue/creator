...
class Task:
    """任务节点"""
    id: str
    task_type: str  # chapter, scene, etc.
...
class DependencyGraph:
    ...
    def __init__(self):
        ...
        self.dependencies: Dict[str, Set[str]] = defaultdict(set)  # task_id -> 依赖的任务ID集合
        self.dependents: Dict[str, Set[str]] = defaultdict(set)  # task_id -> 依赖此任务的任务ID集合
