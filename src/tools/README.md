...
├── base.py              # Function 基类和注册表
├── calculator.py        # 计算器工具示例
├── weather.py           # 天气查询工具示例
├── time.py              # 时间查询工具示例
├── example.py           # 完整使用示例（包括基础使用、LLM 集成和 API 集成）
├── test_tools.py        # 测试代码
└── README.md            # 本文档
```
...
# 输出: ['calculator', 'get_weather', 'get_current_time']
